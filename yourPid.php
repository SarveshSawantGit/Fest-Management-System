...
<html lang="en">
  ...
  <div class="view min-vw-100 min-vh-100"
    ...
    $sql = "SELECT Pid FROM registration ORDER BY Pid DESC LIMIT 1";
    $result = $conn->query($sql);

    if($result){
        while($row = $result -> fetch_row()){
        echo nl2br("<p align='center'> <font color=black  size='6pt'>Your Participation Id is  : ". $row[0]);
        echo nl2br("<p align='center'> <font color=black  size='3pt'>!! Notedown your PID !!");
        echo nl2br("<p align='center'> <font color=black  size='5pt'>Use this PID to participate in events");
        }
    } else{
